 ...
 */
// write your code here
var starWarsCharacters = ["Heroes":starWarsHeros,"Villains":starWarsVillains,"Droids":starWarsDroids]
 ...
 */
// write your code here
let characters=Array(starWarsCharacters.keys)
...
if starWarsCharacters.isEmpty {
    ...
    print("There are \(starWarsCharacters.count) items in the dicyionary")
}
...
if let newKey=starWarsCharacters["Jedi"]{
...
if let removedKey=starWarsCharacters["Bounty Hunters"]{
